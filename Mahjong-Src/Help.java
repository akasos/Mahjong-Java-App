 ...
 * the HyperlinkListener interface, which allows hyperlinking HTML help files together.  Hyperlinks
...
public class Help extends JPanel implements HyperlinkListener
{
    ...
    /**
     * Builds a help system that is displayed in a standalone frame.
    ...
    public Help(String file, String title)
    {
        ...
        frame = new JFrame();
        URL	url = Help.class.getResource("img/Help24.gif");
        ...
        JButton	close = ButtonFactory.makeImageButton("img/Stop24.gif", "Close the help system",
                "close", this, true);
    ...
    /**
     * Builds a help system in the form of a panel that can be displayed in a frame, a panel,
    ...
    public Help(String file)
    {
        ...
        back = ButtonFactory.makeImageButton("img/Back24.gif", "Return to the previous help page", "back", this, true);
        next = ButtonFactory.makeImageButton("img/Forward24.gif", "Goto the next help page", "forward", this, true);
